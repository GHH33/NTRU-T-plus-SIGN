...
#ifdef PARAM_1 //d=8
#define M_HB_Z1 9 // Alphabet size for HighBits(z1)
static uint32_t f_hb_z1[M_HB_Z1] = {1, 1, 31, 242, 472, 243, 32, 1, 1};
#define M_H 9 // Alphabet size for h
static uint32_t f_h[M_H]         = {1, 3, 45, 237, 453, 236, 45, 3, 1};
#endif



#ifdef PARAM_2 //d=8
#define M_HB_Z1 11 // Alphabet size for HighBits(z1)
static uint32_t f_hb_z1[M_HB_Z1]  =  {1, 1, 5, 65, 247, 386, 247, 65, 5, 1, 1};
#define M_H 11 // Alphabet size for h
static uint32_t f_h[M_H]          = {1, 1, 8, 71, 245, 372, 245, 71, 8, 1, 1};
#endif

#ifdef PARAM_3 //d=9
#define M_HB_Z1 7 // Alphabet size for HighBits(z1)
static uint32_t f_hb_z1[M_HB_Z1] = {1, 6, 202, 606, 202, 6, 1};
#define M_H 7 // Alphabet size for h
static uint32_t f_h[M_H]         = {1, 12, 221, 556, 221, 12, 1};
#endif
