...
#ifdef PARAM_1 //2d
#define M_H 7 // Alphabet size for HighBits(z1)
static uint32_t f_h[M_H]         = {2, 36, 244, 459, 245, 36, 2};
#define M_HB_Z1 7 // Alphabet size for h
static uint32_t f_hb_z1[M_HB_Z1] = {2, 45, 247, 435, 248, 45, 2};
#endif

#ifdef PARAM_2 //2d
#define M_HB_Z1 7 // Alphabet size for h
static uint32_t f_hb_z1[M_HB_Z1]  = {1, 1, 167, 686, 167, 1, 1};
#define M_H 7
static uint32_t f_h[M_H] = {1, 4, 200, 615, 199, 4, 1};
#endif

#ifdef PARAM_3 //d=9
#define M_H 7 // Alphabet size for h
static uint32_t f_h[M_H]         = {1, 6, 204, 602, 204, 6, 1};
#define M_HB_Z1 7
static uint32_t f_hb_z1[M_HB_Z1] = {1, 12, 223, 552, 223, 12, 1};
#endif
